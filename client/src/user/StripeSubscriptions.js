...
subscriptionActions=()=>{
  ...
  <FormGroup>
     ...
     <Radio onChange={this.selectplan} checked={this.state.plan==="Quick Size Plus (Yearly)"} value="Quick Size Plus (Yearly)" name="frequencyGroup">Quick Size Plus (Yearly) $40 per year ($20 annual savings over monthly plan)</Radio>
     <Radio onChange={this.selectplan} checked={this.state.plan==="Quick Size Plus (Monthly)"} value="Quick Size Plus (Monthly)" name="frequencyGroup">Quick Size Plus (Monthly) $5 per month</Radio>
     </FormGroup>
    
    </Well> 
  <br/>
  <Button onClick={this.purchaseSubscription}>Purchase Subscription</Button>
  </div>
  )
  if(!activeSubscription&&this.state.upgradeSelected&&this.state.purchaseSelected)
  return(
    ...
    <div className="example">
      ...
      <br/>
      Billing Frequency: {this.state.plan==="Quick Size Plus (Yearly)"&&"Yearly"} {this.state.plan==="Quick Size Plus (Monthly)"&&"Monthly"}
      <br/>
      Amount: {this.state.plan==="Quick Size Plus (Yearly)"&&"USD $40.00"} {this.state.plan==="Quick Size Plus (Monthly)"&&"USD $5.00"}
      <br/>
      <br/>
      {this.state.plan==="Quick Size Plus (Yearly)"&&"Your initial charge will be USD $40.00 and your subscription will automatically renew annually unless canceled."}
      {this.state.plan==="Quick Size Plus (Monthly)"&&"Your initial charge will be USD $5.00 and your subscription will automatically renew monthly unless cancelled."}
      <Elements>
