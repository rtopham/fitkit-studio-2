...
const sizingPDF = (
  ...
  pdf.textWithLink(user.email, FTlabelColumn + 11, line[3], {
  ...
  pdf.text(
    SRdataColumn,
    line[3],
    bike.minSaddle.toString() + ' - ' + bike.maxSaddle.toString()
  )
  ...
  pdf.text(
    SRdataColumn,
    line[7],
    bike.minSaddleWidth.toString() + ' - ' + bike.maxSaddleWidth.toString()
  )
  ...
  pdf.text(
    SRdataColumn,
    line[15],
    (bike.adjustedDropTopTubeAndStem - 2).toString()
  )
