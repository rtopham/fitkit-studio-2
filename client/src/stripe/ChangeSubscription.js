...
return( 
  ...
  <Well>
   ...
   <FormGroup>
     ...
     <Radio onChange={this.props.changeSubscription} value="Quick Size Plus (Yearly)" name="changeSubscriptionGroup">Upgrade to a yearly plan ($100 per year--$20 annual savings compared to monthly plan)</Radio>}
     {this.props.stripeSubscription.plan.interval==="year"&&
     <Radio onChange={this.props.changeSubscription} value="Quick Size Plus (Monthly)" name="changeSubscriptionGroup">Downgrade to a monthly plan ($10 per month --annual increase of $20 compared to yearly plan)</Radio>}
