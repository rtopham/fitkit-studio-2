...
class CoreMeasurements extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="row">
      <QuickSizeInput label="Torso" units="cm." value={this.props.bodyMeasurements.torso} overlay={torsoHelp} min={50} max={75} step={.1} onChange={this.props.changeTorso} />
      <QuickSizeInput label="Arm" units="cm." value={this.props.bodyMeasurements.arm} overlay={armHelp} min={50} max={70} step={.1} onChange={this.props.changeArm} />
      </div>       
      <div className="row">
      <QuickSizeSlider label="Torso" units="cm." value={this.props.bodyMeasurements.torso} overlay={torsoHelp} min={50} max={75} step={.1} onChange={this.props.changeTorso} />
      <QuickSizeSlider label="Arm" units="cm." value={this.props.bodyMeasurements.arm} overlay={armHelp} min={50} max={70} step={.1} onChange={this.props.changeArm} />
      </div>
      </div>
