...
<defs id={"def-"+this.props.tab}>
    ...
    <marker id={"arrowSVG"+this.id} markerWidth="10" markerHeight="10" refX="0" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="black" />
    </marker>
{this.props.tab!==2&&
...
{drawSVGHorizontalLineArrowText(bottomBracketCenter.x,topTubeCenter.y,topTubeCenter.x,"black",this.props.markerId,"frame reach")}
{drawSVGHorizontalLineArrowText(seatTubeCenter.x,topTubeCenter.y-lineSpacing,topTubeCenter.x,"black", this.props.markerId,"effective top tube")}
{/*{drawSVGHorizontalLineArrowText(saddleNose.x,topTubeCenter.y-2*lineSpacing,topTubeCenter.x,"black", this.props.markerId,"handlebar reach")}*/}
{drawSVGHorizontalLineArrowText(saddleNose.x,topTubeCenter.y-2*lineSpacing,barCenter.x,"black", this.props.markerId,"saddle nose to bar center")}
{drawSVGHorizontalLineArrowText(saddleNose.x,topTubeCenter.y-3*lineSpacing-4,hoodTrough.x,"black", this.props.markerId,"saddle nose to hood trough")}
...
{drawSVGLineArrow(bottomBracketCenter.x,topTubeCenter.y+5,saddleNose.x+8, topTubeCenter.y+5,"black", this.props.markerId)}
...
{drawSVGVerticalLineArrowText(bottomBracketCenter.x,topTubeCenter.y,bottomBracketCenter.y,"black", this.props.markerId,100,0,true,"frame","stack")}
...
{drawSVGVerticalLineDashed(topTubeCenter.x,saddlePlane.y,topTubeCenter.y,dashColor, this.props.markerId)}
{drawSVGVerticalLineDashed(barCenter.x,saddlePlane.y,barCenter.y,dashColor, this.props.markerId)}
...
{drawSVGText(saddleNose.x-30,topTubeCenter.y+20, "black", this.props.markerId,"saddle","setback")}
